  ...
  return (
    <footer className="border-t border-navy-border bg-navy-card/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-10 mb-16">
          ...
          <div className="col-span-2">
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-xs mb-6">
              Modern digital banking and investment platform for the next generation of wealth builders.
            </p>
          ...
          {Object.entries(footerLinks).map(([group, links]) => (
            <div key={group}>
              <p className="font-display font-semibold text-white text-sm mb-4">{group}</p>
        ...
        {/* Bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 border-t border-navy-border">
