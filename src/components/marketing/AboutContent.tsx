                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
                    <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                        ...
                        <p className="text-white/50 text-xl max-w-2xl mx-auto">
                            NexVault was founded in 2021 with a simple belief: everyone deserves
                            access to a world-class banking and investment experience.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-20">
                <div className="max-w-2xl mx-auto px-4 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <Link href="/register">
                            <Button className="h-12 px-10 bg-brand-blue hover:bg-blue-600 text-white font-semibold rounded-xl shadow-lg shadow-blue-500/20">
                                Create Free Account
                            </Button>
                        </Link>
                    </motion.div>
